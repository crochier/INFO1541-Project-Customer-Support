...
public class Bootstrap implements WebApplicationInitializer {
    ...
    public void onStartup(ServletContext container) throws ServletException {
        ...
        // get the application context configuration and set up the dispatcher from Spring
        ...
        dispatcher.setMultipartConfig(new MultipartConfigElement(null, 20_971_200L, 41_943_040L, 5_242_880));
