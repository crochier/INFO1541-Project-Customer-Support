...
@Repository
public class DefaultAttachmentRepository extends GenericJpaRepository<String, Attachment> implements AttachmentRepository
{
    @Override
    public Map<String, Attachment> getByTicketId(Long ticketId)
    {
        try {
            ...
            List<Attachment> attachmentList = this.entityManager.createQuery
                    ("SELECT a FROM Attachment a WHERE a.ticketId = :id",
