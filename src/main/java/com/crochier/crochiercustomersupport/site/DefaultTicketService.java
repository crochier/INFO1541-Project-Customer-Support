...
public class DefaultTicketService implements TicketService
{
    ...
    private Ticket convert(TicketEntity entity)
    {
        ...
        ticket.setTicketSubject(entity.getSubject());
        ticket.setTicketBody(entity.getBody());
    ...
    public void save(Ticket ticket)
    {
        ...
        entity.setSubject(ticket.getTicketSubject());
        entity.setBody(ticket.getTicketBody());
        if (ticket.getId()<1)
        {
